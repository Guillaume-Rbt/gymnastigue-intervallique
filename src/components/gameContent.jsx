...
export default function GameContent() {
	...
	return (
		<div className={`game-content ${gameSession <= 0 || intervalNumber > 10 ? "init-game" : ""}`}>
			...
			<AnimatePresence mode='popLayout'>
				{intervalNumber > 9 && gameSession > 0 && (
					<motion.div variants={variants} initial='visible' transition={{ duration: 0.3 }} animate='visible' exit='hidden' className='game-content__card'>
