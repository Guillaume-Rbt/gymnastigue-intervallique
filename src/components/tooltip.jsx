...
export default function Tooltip({ children, text, positon = "topCenter", buttonRef }) {
    ...
    useEffect(() => {
        ...
        window.addEventListener("resize", () => { setCoords(calcPosition()) })
        ...
        return () => window.removeEventListener("resize", () => { setCoords(calcPosition()) })
    }, [])
